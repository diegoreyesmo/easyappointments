...
$lang['support'] = 'サポート';
$lang['about_app_support'] = ' AgendaRRF を利用する上で もし何か 問題がありましたら 、是非　公式 Google Groupを検索して 解決方法を見つけてください。もしかしたら 開発をさらに良いものにするために 新しい課題を Google Code に 登録することもできます。';
...
$lang['license'] = 'ライセンス';
$lang['about_app_license'] = 'AgendaRRF は　GPLv3 ライセンス に従います。 AgendaRRF　のプログラムコードを使用するということは、あるあらゆる面で 次のURLのサイトにある条件に同意したこととなります。:';
...
$lang['ea_update_success'] = 'AgendaRRF の　アップデートが成功しました。';
...
$lang['api_token_hint'] = 'AgendaRRF APIのトークンベースの認証を有効にするために、秘密のトークンを設定します。';
