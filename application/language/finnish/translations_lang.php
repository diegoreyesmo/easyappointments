...
$lang['about_app'] = 'Tietoja AgendaRRF:sta';
...
$lang['about_app_info'] = 'AgendaRRF on web-sovellus jonka avulla asiakkaasi voivat varata aikoja netissä. Lisäominaisuutena on mahdollisuus synkronoida tapaamiset Google-kalenteriin, jolloin varaustietojen käyttö muissa palveluissa on helppoa.';
...
$lang['about_app_license'] = 'AgendaRRF on GPLv3 lisensoitu. Käyttämällä Easy!Appointmentsia palvelutuotannossa tai muilla lisenssissä mainituilla tavoilla suostut linkissä oleviin lisenssiehtoihin:';
...
$lang['ea_update_success'] = 'AgendaRRF päivitettiin onnistuneesti.';
...
$lang['api_token_hint'] = 'Aseta secret token aktivoidaksesi token-pohjaisen autentikoinnin AgendaRRF API:lle.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'Tämä mahdollistaa kaiken AgendaRRF -datan käsittelyn HTTP-protokollan ja API-rajapinnan kautta. Tällä voit luoda omia integraatioita järjestelmään.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Tämä integrointi mahdollistaa käyttäjien yhdistämisen olemassa olevaan LDAP-palvelimeen. Käyttäjät tuodaan automaattisesti AgendaRRF:iin, jolloin he voivat kirjautua AD-tunnuksillaan (käyttäjänimen tulee olla sama).';
$lang['host'] = 'Isäntä';
$lang['port'] = 'Portti';
