...
$lang['about_app'] = 'About AgendaRRF';
...
$lang['about_app_info'] = 'AgendaRRF is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using AgendaRRF you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'AgendaRRF is licensed under the GPLv3 license. By using the code of AgendaRRF in any way you are agreeing to the terms described in the following url:';
...
$lang['ea_update_success'] = 'AgendaRRF has been successfully updated.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the AgendaRRF API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the AgendaRRF data via the HTTP protocol and the available API endpoints and create your own integrations.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'This integration enables you to connect to an existing LDAP server and automatically import users into AgendaRRF and let them SSO with their directory password (username must match).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
...
$lang['mercadopago_settings'] = 'MercadoPago Settings';
$lang['mercadopago_enabled'] = 'Enable MercadoPago';
$lang['mercadopago_access_token'] = 'Access Token';
$lang['mercadopago_access_token_hint'] = 'Access token from your MercadoPago account.';
$lang['mercadopago_public_key'] = 'Public Key';
$lang['mercadopago_client_id'] = 'Client ID';
$lang['mercadopago_client_secret'] = 'Client Secret';
$lang['mercadopago_sandbox'] = 'Sandbox Mode';
$lang['mercadopago_currency'] = 'Currency';
$lang['mercadopago_statement_descriptor'] = 'Statement Descriptor';
$lang['mercadopago_statement_descriptor_hint'] = 'Text that will appear on the customer statement (max 20 chars).';
$lang['payment_required'] = 'Payment Required';
$lang['pay_with_mercadopago'] = 'Pay with MercadoPago';
$lang['payment_amount'] = 'Amount to Pay';
$lang['payment_pending'] = 'Payment Pending';
$lang['payment_approved'] = 'Payment Confirmed';
$lang['payment_rejected'] = 'Payment Rejected';
$lang['payment_processing'] = 'Processing Payment...';
$lang['payment_success_message'] = 'Your payment was processed successfully.';
$lang['payment_failure_message'] = 'The payment could not be processed. Please try again.';
$lang['payment_webhook_url'] = 'Webhook URL';
$lang['payment_webhook_url_hint'] = 'Configure this URL in your MercadoPago panel to receive payment notifications.';
$lang['test_connection'] = 'Test Connection';
$lang['payment_step'] = 'Payment';
$lang['complete_payment_to_confirm'] = 'Complete payment to confirm your appointment';
$lang['payment_secure_message'] = 'Secure payment processed by MercadoPago';
$lang['payment_configuration'] = 'Payment Configuration';
$lang['webhook_configuration'] = 'Webhook Configuration';
$lang['setup_instructions'] = 'Setup Instructions';
$lang['mp_instruction_1'] = 'Create an account at MercadoPago Developers.';
$lang['mp_instruction_2'] = 'Generate your application credentials (Access Token and Public Key).';
$lang['mp_instruction_3'] = 'Enter the credentials in the corresponding fields.';
$lang['mp_instruction_4'] = 'Configure the webhook URL in your MercadoPago panel.';
$lang['mp_instruction_5'] = 'Enable payments and test in Sandbox mode before going to production.';
$lang['email_required_for_payment'] = 'An email is required to process the payment.';
$lang['payment_approved_notification_subject'] = 'Payment Confirmed - Your Appointment is Booked';
$lang['payment_approved_notification_message'] = 'Your payment has been processed successfully. Your appointment has been confirmed.';
$lang['payment_confirmed_for_provider'] = 'The appointment payment has been confirmed.';
$lang['payment_confirmed'] = 'A payment has been confirmed successfully.';
$lang['copied_to_clipboard'] = 'URL copied to clipboard.';
$lang['connection_successful'] = 'Connection to MercadoPago successful.';
$lang['connection_failed'] = 'Could not connect to MercadoPago.';
