        ...
        try {
            ...
            foreach ($local_events as $local_event) {
                ...
                try {
                    ...
                    // If CalDAV Calendar event is different from AgendaRRF appointment then update AgendaRRF record.
                    ...
                    // Appointment not found on CalDAV Calendar, delete from AgendaRRF.
            ...
            // Add CalDAV Calendar events that do not exist in AgendaRRF.
            ...
            // from the calendar synchronization and not from AgendaRRF itself).
